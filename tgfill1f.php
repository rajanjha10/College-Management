...
<div class="main" >
 <div class="logo">
        <div class="form-group" style="margin: 30px; margin-left: 150px;" align="center" >
...
<div class="container">
	<div class="panel panel-primary" style="margin-left: 50px; margin-top: 100px;text-align:center;width:900px;border-radius:10px;">
